...
export default class CommentWrapper extends Component {
    ...
    onCreateComment = () => {
        ...
        CommentService.createCommentForPodcast(
    ...
    componentDidMount = () => {
        CommentService.findCommentsForPodcast(this.props.podcastId).then(
            data => {
                this.setState({
                    comments: data
                });
                                ...
                                <form className="form">
                                    <div className="form-group">
                                        ...
                                        <button
                                            ...
                                            className="mt-2 podcast-comments-btn btn__alt"
                                        >
                                            Submit
                                        </button>
                                    </div>
