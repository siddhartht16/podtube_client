                        ...
                        <div className="row mt-3">
                            <div className="col-md-3">
                                <div className="admin-card">
                                    ...
                                    <p>Users: <span className="count">{this.state.appStats.noOfTotalUsers}</span></p>
                                </div>
                            </div>
                            <div className="col-md-3">
                                <div className="admin-card">
                                    <p><span className="fa fa-list icon"/></p>
                                    <p>Categories: <span className="count">{this.state.appStats.noOfCategories}</span></p>
                                </div>
                            </div>
                            <div className="col-md-3">
                                <div className="admin-card">
                                    <p><span className="fa fa-podcast icon"/></p>
                                    <p>Podcasts: <span className="count">{this.state.appStats.noOfPodcasts}</span></p>
                                </div>
                            </div>
                            <div className="col-md-3">
                                <div className="admin-card">
                                    <p><span className="fa fa-tv icon"/></p>
                                    <p>Episodes: <span className="count">{this.state.appStats.noOfEpisodes}</span></p>
                                </div>
                            </div>
