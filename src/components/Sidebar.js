                ...
                <ul className="sidebar-list">
                    <li>
                        <Link
                            to="/categories"
                            onClick={() =>
                                this.changeActiveClassForLink("categories")
                            }
                            className={
                    ...
                    <li>
                        <Link
                            to="/subscriptions"
                            className={
                                "" + this.state.active === "subscriptions"
                                    ? "active"
                                    : null
                            }
                            onClick={() =>
                                this.changeActiveClassForLink("subscriptions")
                            }
                        >
                            <i
                    ...
                    <li>
                        <Link
                            to="/bookmarks"
                            className={
                                "" + this.state.active === "bookmarks"
                                    ? "active"
                                    : null
                            }
                            onClick={() =>
                                this.changeActiveClassForLink("bookmarks")
                            }
                        >
                    ...
                    <li>
                        <Link
                            ...
                            onClick={() =>
                                this.changeActiveClassForLink("profile")
                            }
                        >
